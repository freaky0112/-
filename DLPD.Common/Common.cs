...
namespace DLPD.Common {
    ...
    public class ZRZLF {
        ...
        public ZRZLF() {
            ...
            this.gchd = new GCHD();
            this.tkzk = new TKZK();
            this.yjzhl = new YJZHL();
            this.tjdltj = new TJDLTJ();
            this.ggbzl = new GGBZL();
            this.hb = new HB();
        }
    ...
    public class GDZLDJ {
        ...
        /// </summary>
        /// <returns></returns>
        public double ToGJJJDZS() {
            double jjdzs = ToZRDZS() * lyxs * jjxs * 0.6029 + 509.57;
            return jjdzs;
        }
        /// <summary>
        /// 国家级利用等级计算
        ...
        public int ToGJJJDB() {
            ...
            dynamic config = ruby.GJLYDB.@new();
            double gjlydzs = this.ToGJLYDZS();
            gjjjdb = config.getGJLYDB(gjlydzs);
            return gjjjdb;
        }
